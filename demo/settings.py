...
APP_NAME = (
    "{{ project_name }} Demo Application"  # Displayed in some generic UI scenarios
)
...
FINTI_SIMULATE_CALLS = (
    False  # Simulate Finti calls. 404 if response not previously saved.
)
FINTI_SIMULATE_WHEN_POSSIBLE = (
    False  # Simulate Finti calls only when cached response exists.
)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "libraries": {
                "{{ project_name }}_taglib": "psu_{{ project_name }}.templatetags.{{ project_name }}_taglib",
            },
        },
    },
]
